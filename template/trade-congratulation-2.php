<div class="trade_congratulation-2">
	<div class="trade_submit__close">
		X
	</div>
	<div class="trade_submit__info">
		<div class="trade_submit__info-description">
			<p class="trade_submit__info-description-heading">Поздравляем!</p>
			<p class="trade_submit__info-description-title">Ваше фото опубликовано в коллекцию</p>
